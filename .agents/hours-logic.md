...
*   **Presentee Report:** For CLM Presentee files, cross-punch logic is *not* applied. The application assumes the data provided in the Presentee Report is already correctly formatted and paired for overnight shifts by the CLM system.
